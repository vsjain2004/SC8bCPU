...
And Indexed & AND(X) & P & R[Rd] = R[R1] \& M[R2 + SignExtImm] & AND Rd, R1, Imm[R2] & --\\
...
Or Indexed & OR(X) & P & R[Rd] = R[R1] \textbar ~M[R2 + SignExtImm] & OR Rd, R1, Imm[R2] & --\\
...
Xor Indexed & XOR(X) & P & R[Rd] = R[R1] $\oplus$ M[R2 + SignExtImm] & XOR Rd, R1, Imm[R2] & --\\
