...
Any Load/Store with Label & -- & P & R[Rd] = M[Label] or M[Label] = R[Rd] & LD? or ST? Rd, Label & --\\
\bottomrule
\end{tabular}
...
Jump Label if Not Equal & JPN(L) & P & If Flags, PC = Label & JPN Label & --\\
...
Jump Label if Equal & JPE(L) & P & If Flags, PC = Label & JPE Label & --\\
...
Jump Label if Greater Than & JGT(L) & P & If Flags, PC = Label & JGT Label & --\\
...
Jump Label if Greater Than Unsigned & JGT(L)U & P & If Flags, PC = Label & JGTU Label & --\\
...
Jump Label if Greater Than or Equal & JGE(L) & P & If Flags, PC = Label & JGE Label & --\\
...
Jump Label if Greater Than or Equal Unsigned & JGE(L)U & P & If Flags, PC = Label & JGEU Label & --\\
