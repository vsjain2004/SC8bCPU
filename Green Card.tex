...
\begin{tikzpicture}[scale=.65, every node/.style={scale=0.59}]
  ...
  \foreach \x in {2,4,6} \draw (\x,0) -- (\x,1);
  \node at (1,0.5) {Opcode};
  \node at (3,0.5) {R1};
  \node at (5,0.5) {R2};
  \node at (6.5,0.5) {00};
  ...
  \node[below] at (1.75,0) {12};
  \node[below] at (2.25,0) {11};
  \node[below] at (3.75,0) {7};
  \node[below] at (4.25,0) {6};
  \node[below] at (5.75,0) {2};
  \node[below] at (6.25,0) {1};
...
\begin{tikzpicture}[scale=.65, every node/.style={scale=0.59}]
  ...
  \foreach \x in {2,4,6,12} \draw (\x,0) -- (\x,1);
  \node at (1,0.5) {Opcode};
  \node at (3,0.5) {Rd};
  \node at (5,0.5) {R1};
  \node at (9,0.5) {Immediate};
  \node at (12.5,0.5) {01};

  \node[below] at (0.25,0) {31};
  \node[below] at (1.75,0) {28};
  \node[below] at (2.25,0) {27};
  \node[below] at (3.75,0) {23};
  \node[below] at (4.25,0) {22};
  \node[below] at (5.75,0) {18};
  \node[below] at (6.25,0) {17};
  \node[below] at (11.75,0) {2};
  \node[below] at (12.25,0) {1};
...
\begin{tikzpicture}[scale=.65, every node/.style={scale=0.59}]
  \draw (0,0) rectangle (13,1);
  \foreach \x in {2,4,6,8,10,12} \draw (\x,0) -- (\x,1);
  \node at (1,0.5) {Opcode};
  \node at (3,0.5) {Rd};
  \node at (5,0.5) {R1};
  \node at (7,0.5) {R2/ShiftAmt};
  \node at (9,0.5) {Family};
  \node at (11,0.5) {Function};
  \node at (12.5,0.5) {01};
  ...
  \node[below] at (5.75,0) {18};
  \node[below] at (6.25,0) {17};
  \node[below] at (7.75,0) {13};
  \node[below] at (8.25,0) {12};
  \node[below] at (9.75,0) {11};
  \node[below] at (10.25,0) {10};
  \node[below] at (11.75,0) {2};
  \node[below] at (12.25,0) {1};
  \node[below] at (12.75,0) {0};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=.65, every node/.style={scale=0.59}]
  \draw (0,0) rectangle (13,1);
  \foreach \x in {2,4,6,8,9,11,12} \draw (\x,0) -- (\x,1);
  \node at (1,0.5) {13$_{\text{dec}}$};
  \node at (3,0.5) {Rd1};
  \node at (5,0.5) {R1};
  \node at (7,0.5) {R2};
  \node at (8.5,0.5) {10};
  \node at (10,0.5) {Rd2};
  \node at (11.5,0.5) {Func};
  \node at (12.5,0.5) {01};
  ...
  \node[below] at (10.75,0) {6};
  \node[below] at (11.25,0) {5};
  \node[below] at (11.75,0) {2};
  \node[below] at (12.25,0) {1};
  \node[below] at (12.75,0) {0};
\end{tikzpicture}
...
JMPAddr & \{NextInst[31:17], Immediate, 1'b0\} \\
OpX & Imm, [Reg], (Imm)[Reg] or Reg\\
...
\section*{Assembly Immediate Format}
\begin{tabular}{ll}
\toprule
Prefix & Base\\
\midrule
...
T[S] & Array of type T. Size S can be specified\\
string & Any size array of chars\\
\bottomrule
\end{tabular}
...
\begin{tabular}{>{\raggedright\arraybackslash\hangindent=0.5cm\hangafter=1}p{3cm}>{\raggedright\arraybackslash\hangindent=0cm\hangafter=1}p{2cm}c>{\raggedright\arraybackslash\hangindent=1.5cm\hangafter=1}p{5cm}lc}
\toprule
Instruction & Mnemonic & Format & Operation (in Verilog) & Assembly & Opcode(dec) \\
\midrule
Load Immediate & LDM & I & R[Rd] = SignExtImm & LDM Rd, Imm & 0\\
Load Immediate Upper & LDMU & I & R[Rd] = Immediate $<<$ 16 & LDMU Rd, Imm & 1\\
Load Word Direct & LDW(D) & I & R[Rd] = M[R[R1]] & LDW Rd, [R1] & 2\\
Load Word Indexed & LDW(X) & I & R[Rd] = M[R[R1] + SignExtImm] & LDW Rd, (Imm)[R1] & 2\\
Load Half-Word Direct & LDH(D) & I & R[Rd] = \{16'b0, M[R[R1]](15:0)\} & LDH Rd, [R1] & 3\\
Load Half-Word Indexed & LDH(X) & I & R[Rd] = \{16'b0, M[R[R1] + SignExtImm](15:0)\} & LDH Rd, (Imm)[R1] & 3\\
Load Byte Direct & LDB(D) & I & R[Rd] = \{24'b0, M[R[R1]](7:0)\} & LDB Rd, [R1] & 4\\
Load Byte Indexed & LDB(X) & I & R[Rd] = \{24'b0, M[R[R1] + SignExtImm](7:0)\} & LDB Rd, (Imm)[R1] & 4\\
Store Word Direct & STW(D) & I & M[R[R1]] = R[Rd]& STW Rd, [R1] & 5\\
Store Word Indexed & STW(X) & I & M[R[R1] + SignExtImm] = R[Rd] & STW Rd, (Imm)[R1] & 5\\
Store Half-Word Direct & STH(D) & I & M[R[R1]] = R[Rd](15:0) & STH Rd, [R1] & 6\\
Store Half-Word Indexed & STH(X) & I & M[R[R1] + SignExtImm] = R[Rd](15:0) & STH Rd, (Imm)[R1] & 6\\
Store Byte Direct & STB(D) & I & M[R[R1]] = R[Rd](7:0) & STB Rd, [R1] & 7\\
Store Byte Indexed & STB(X) & I & M[R[R1] + SignExtImm] = R[Rd](7:0) & STB Rd, (Imm)[R1] & 7\\
Load Jump Address & LDJ & I & R[Rd] = JMPAddr & LDJ Rd, Imm & 12\\
Any Load/Store with Label & LD?(L) or ST?(L) & P & R[Rd] = M[Label] or M[Label] = R[Rd] or R[Rd] = Label & LD? or ST? Rd, Label & --\\
\bottomrule
\end{tabular}
...
\toprule
Instruction & Mnemonic & Format & Operation (in Verilog) & Assembly & Opcode/Family/ Func(dec) \\
\midrule
Add Immediate & ADD(M) & P & R[Rd] = R[R1] + SignExtImm & ADD Rd, R1, Imm & --\\
Add Direct & ADD(D) & R2 & R[Rd] = R[R1] + M[R[R2]] & ADD Rd, R1, [R2] & 13/0/0\\
Add Indexed & ADD(X) & P & R[Rd] = R[R1] + M[R[R2] + SignExtImm] & ADD Rd, R1, (Imm)[R2] & --\\
...
Subtract Direct & SUB(D) & R2 & R[Rd] = R[R1] - M[R[R2]] & SUB Rd, R1, [R2] & 13/0/2\\
Subtract Indexed & SUB(X) & P & R[Rd] = R[R1] - M[R[R2] + SignExtImm] & SUB Rd, R1, (Imm)[R2] & --\\
...
And Direct & AND(D) & R2 & R[Rd] = R[R1] \& M[R[R2]] & AND Rd, R1, [R2] & 13/1/0\\
And Indexed & AND(X) & P & R[Rd] = R[R1] \& M[R[R2] + SignExtImm] & AND Rd, R1, (Imm)[R2] & --\\
And Register & AND(R) & R2 & R[Rd] = R[R1] \& R[R2] & AND Rd, R1, R2 & 13/1/1\\
Or Immediate & OR(M) & I & R[Rd] = R[R1] \textbar ~ZeroExtImm & OR Rd, R1, Imm & 8\\
Or Direct & OR(D) & R2 & R[Rd] = R[R1] \textbar ~M[R[R2]] & OR Rd, R1, [R2] & 13/1/2\\
Or Indexed & OR(X) & P & R[Rd] = R[R1] \textbar ~M[R[R2] + SignExtImm] & OR Rd, R1, (Imm)[R2] & --\\
...
Xor Direct & XOR(D) & R2 & R[Rd] = R[R1] $\oplus$ M[R[R2]] & XOR Rd, R1, [R2] & 13/1/4\\
Xor Indexed & XOR(X) & P & R[Rd] = R[R1] $\oplus$ M[R[R2] + SignExtImm] & XOR Rd, R1, (Imm)[R2] & --\\
Xor Register & XOR(R) & R2 & R[Rd] = R[R1] $\oplus$ R[R2] & XOR Rd, R1, R2 & 13/1/5\\
Arithmetic Shift Right Immediate & ASR & R2 & R[Rd] = R[R1] $>>>$ ShiftAmt & ASR Rd, R1, ShiftAmt & 13/1/6\\
Arithmetic Shift Right Register & ASRR & R2 & R[Rd] = R[R1] $>>>$ R[R2] & ASRR Rd, R1, R2 & 13/1/7\\
Logical Shift Left Immediate & LSL & R2 & R[Rd] = R[R1] $<<$ ShiftAmt & LSL Rd, R1, ShiftAmt & 13/1/8\\
Logical Shift Left Register & LSLR & R2 & R[Rd] = R[R1] $<<$ R[R2] & LSLR Rd, R1, R2 & 13/1/9\\
Logical Shift Right Immediate & LSR & R2 & R[Rd] = R[R1] $>>$ ShiftAmt & LSR Rd, R1, ShiftAmt & 13/1/10\\
Logical Shift Right Register & LSRR & R2 & R[Rd] = R[R1] $>>$ R[R2] & LSRR Rd, R1, R2 & 13/1/11\\
Circular Shift Left Immediate & CSL & R2 & R[Rd] = \{R[R1], R[R1]\} $>>$ (32 - ShiftAmt) & CSL Rd, R1, ShiftAmt & 13/1/12\\
Circular Shift Left Register & CSLR & R2 & R[Rd] =\{R[R1], R[R1]\} $>>$ (32 - R[R2]) & CSLR Rd, R1, R2 & 13/1/13\\
Circular Shift Right Immediate & CSR & R2 & R[Rd] = \{R[R1], R[R1]\} $>>$ ShiftAmt & CSR Rd, R1, ShiftAmt & 13/1/14\\
...
\toprule
Instruction & Mnemonic & Format & Operation (in Verilog) & Assembly & Func(dec) \\
\midrule
Multiply Immediate & MULT(M) & P & \{R[Rd2], R[Rd1]\} = R[R1] * SignExtImm & MULT Rd1, Rd2, R1, Imm & --\\
Multiply Direct & MULT(D) & R2 & \{R[Rd2], R[Rd1]\} = R[R1] * M[R[R2]] & MULT Rd, R1, [R2] & 0\\
Multiply Indexed & MULT(X) & P & \{R[Rd2], R[Rd1]\} = R[R1] * M[R[R2] + SignExtImm] & MULT Rd1, Rd2, R1, (Imm)[R2] & --\\
...
Multiply Direct Unsigned & MULT(D)U & R2 & \{R[Rd2], R[Rd1]\} = R[R1] * M[R[R2]] & MULTU Rd1, Rd2, R1, [R2] & 2\\
Multiply Indexed Unsigned & MULT(X)U & P & \{R[Rd2], R[Rd1]\} = R[R1] * M[R[R2] + SignExtImm] & MULTU Rd1, Rd2, R1, (Imm)[R2] & --\\
...
Divide Direct & DIV(D) & R2 & R[Rd1] = R[R1] / M[R[R2]] & DIV Rd1, Rd2, R1, [R2] & 4\\
&&&R[Rd2] = R[R1] \% M[R[R2]]\\
Divide Indexed & DIV(X) & P & R[Rd1] = R[R1] / M[R[R2] + SignExtImm] & DIV Rd1, Rd2, R1, (Imm)[R2] & --\\
&&&R[Rd2] = R[R1] \% M[R[R2] + SignExtImm]\\
...
Divide Direct Unsigned & DIV(D)U & R2 & R[Rd1] = R[R1] / M[R[R2]] & DIVU Rd1, Rd2, R1, [R2] & 6\\
&&&R[Rd2] = R[R1] \% M[R[R2]]\\
Divide Indexed Unsigned & DIV(X)U & P & R[Rd1] = R[R1] / M[R[R2] + SignExtImm] & DIVU Rd1, Rd2, R1, (Imm)[R2] & --\\
&&&R[Rd2] = R[R1] \% M[R[R2] + SignExtImm]\\
...
Div Remainder & REM & P & R[Rd] = R[R1] \% Op2 & REM Rd, R1, Op2 & --\\
Div Quotient Unsigned & DIVU & P & R[Rd] = R[R1] / U(Op2) & DIVU Rd, R1, Op2 & --\\
Div Remainder Unsigned & REMU & P & R[Rd] = R[R1] \% U(Op2) & REMU Rd, R1, Op2 & --\\
\bottomrule
\end{tabular}
...
Compare Direct & CMD & R2 & SetFlags(R[R1] - M[R[R2]]) & CMP R1, [R2] & 13/3/2\\
Compare Indexed & CMX & P & SetFlags(R[R1] - M[R[R2] + SignExtImm]) & CMP R1, (Imm)[R2] & --\\
Compare Register & CMPR & R1 & SetFlags(R[R1] - R[R2]) & CMP R1, R2 & 6\\
Jump & JMP & P & PC = JMPAddr & JMP Immediate & --\\
Jump Label & JMP(L) & P & PC = Label Address & JMP Label & --\\
Jump Register & JMP(R) & R1 & PC = R[R1] & JMP R1 & 10\\
Jump and Link & JAL & P & PC = JMPAddr; R[RA] = NextInst & JAL Immediate & --\\
Jump Label and Link & J(L)AL & P & PC = Label Address; R[RA] = NextInst & JAL Label & --\\
Jump and Link Register & JAL(R) & P & PC = JMPAddr; R[R1] = NextInst & JAL R1, Imm & --\\
Jump Label and Link Register & J(L)AL(R) & P & PC = Label Address; R[R1] = NextInst & JAL R1, Label & --\\
Jump Register and Link & J(R)AL & P & PC = R[R1]; R[RA] = NextInst & JAL R1 & --\\
...
Jump Label if Not Equal & JP(L)N & P & If Flags, PC = Label & JPN Label & --\\
...
Jump Label if Equal & JP(L)E & P & If Flags, PC = Label & JPE Label & --\\
...
Jump Label if Greater Than & J(L)GT & P & If Flags, PC = Label & JGT Label & --\\
...
Jump Label if Greater Than Unsigned & J(L)GTU & P & If Flags, PC = Label & JGTU Label & --\\
...
Jump Label if Greater Than or Equal & J(L)GE & P & If Flags, PC = Label & JGE Label & --\\
...
Jump Label if Greater Than or Equal Unsigned & J(L)GEU & P & If Flags, PC = Label & JGEU Label & --\\
