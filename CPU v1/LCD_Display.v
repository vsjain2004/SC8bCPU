...
module LCD_Display(iCLK_50MHZ, iRST_N, hex,
...
wire [7:0] Next_Char, hex3, hex2, hex1, hex0;
reg [19:0] CLK_COUNT_400HZ;
reg [4:0] CHAR_COUNT;
reg CLK_400HZ, LCD_RW_INT, LCD_E, LCD_RS;

BCD_7_bit bcd1(.hex(hex), .hex3(hex3), .hex2(hex2), .hex1(hex1), .hex0(hex0));
...
module LCD_display_string(index,out,hex0,hex1,hex2,hex3);
input [4:0] index;
input [7:0] hex3,hex2,hex1,hex0;
output [7:0] out;
reg [7:0] out;
